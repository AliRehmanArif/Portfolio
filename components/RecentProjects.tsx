...
const RecentProjects = () => {
  return (
    <div className="py-20 ">
      ...
      <div className="flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-8  md:grid grid-cols-2">
        {projects.map(({ id, title, des, img, iconLists, link }) => (
          <div
            key={id}
            className="sm:h-[41rem] h-[32rem] lg:min-w-[32.5rem] flex items-center justify-center sm:w-[570px] w-[80vw] "
          >
            <PinContainer title={link} href={link}>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex items-center justify-center">
                  <p className="text-purple text-sm lg:text-xl md:text-xs">
                    Check Live Site
                  </p>
